...
The remaining parameters to infer are $\eta_1,...,\eta_{N}$, where $N = 34$ is the number of nodes in the karate graph. Each $\eta_i$ accounts for the expected degree of node $i$ on the logit scale. The authors refer to this as _node correction_ as well as the more common _degree correction_.  
